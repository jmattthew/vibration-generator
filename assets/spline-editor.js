/*
	...
	https://github.com/Bemmu/jquery-spline-editor
	Original author: Bemmu Sepponen, me@bemmu.com
	MIT license
*/
...
(function ($) {
	...
	function clearBackground() {
		...
		// @mattthew modification:
		// Some spline shapes are not possible if Y is computed across the entire canvas.
		// By drawing a smaller box within the canvas and ingoring Y values outside of that box,
		// all spline shapes can be drawn (e.g. diagonal line from top left to bottom right).
		context.fillStyle = this.settings.backgroundColor;
		var p1x = this.settings.width/8;
		var p1y = this.settings.height/20;
		var p2x = p1x * 6;
		var p2y = p1y * 18;
		context.fillRect(p1x, p1y, p2x, p2y);
	}
